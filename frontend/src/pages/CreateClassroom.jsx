...
const CreateClassroom = () => {
 ...
 <h2 className="text-2xl font-semibold text-slate-800">Create New Classroom</h2>
 </div>
 </header>
 ...
 <span className="mx-2 text-slate-300">/</span>
 <span className="text-slate-900 font-semibold">Create New Classroom</span>
 </nav>

 {/* Form Card */}
 <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden"> {/* Error/Success Messages */}
 {error && (
 ...
 <h3 className="text-xl font-bold text-slate-800">Room Registration</h3>
 ...
 className={`w-full px-4 py-2.5 bg-white border ${fieldErrors.roomCode ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none`}
 placeholder="e.g. R402"
 type="text"
 />
 {fieldErrors.roomCode && (
 <p className="text-xs text-red-600 mt-1">{fieldErrors.roomCode}</p>
 )}
 </div>
 <div className="space-y-2">
 <label className="text-sm font-semibold text-slate-700">
 ...
 onChange={handleInputChange}
 className={`w-full px-4 py-2.5 bg-white border ${fieldErrors.roomName ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none`}
 placeholder="e.g. Bio-Lab 402"
 type="text"
 />
 {fieldErrors.roomName && (
 <p className="text-xs text-red-600 mt-1">{fieldErrors.roomName}</p>
 )}
 </div>
 </div>
 ...
 onChange={handleInputChange}
 className={`w-full px-4 py-2.5 bg-white border ${fieldErrors.building ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none`}
 >
 ...
 onChange={handleInputChange}
 className={`w-full px-4 py-2.5 pr-28 bg-white border ${fieldErrors.capacity ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
 placeholder="50"
 type="number"
 min="1"
 max="250"
 ...
 className="w-4 h-3 flex items-center justify-center text-slate-400 hover:text-slate-600"
 >
 ...
 onChange={handleInputChange}
 />
 <div className="h-full px-2 py-2.5 text-center text-xs font-semibold border border-slate-200 rounded-lg peer-checked:bg-blue-50 peer-checked:border-primary peer-checked:text-primary transition-all">
 Lecture
 </div>
 </label>
 <label className="flex-1 cursor-pointer">
 ...
 <p className="text-xs text-red-600 mt-1">{fieldErrors.roomType}</p>
 )}
 </div>
 </div>
 ...
 <label className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-transparent hover:border-slate-200 cursor-pointer transition-all group">
 <input
 className="w-5 h-5 rounded border-slate-300 text-primary focus:ring-primary focus:ring-offset-0"
 type="checkbox"
 ...
 <div className="w-full lg:w-[420px] p-8 bg-slate-50/50">
 ...
 <div className={`border-2 border-dashed ${fieldErrors.images ? 'border-red-500' : 'border-slate-300'} rounded-2xl p-8 transition-all ${imagesPreviews.length < 5 ? 'hover:border-primary hover:bg-white cursor-pointer' : 'opacity-50 cursor-not-allowed bg-slate-100'} flex flex-col items-center justify-center gap-4 text-center bg-white/40`}>
 ...
 {fieldErrors.images && (
 <p className="text-xs text-red-600 mt-2">{fieldErrors.images}</p>
 )}
 </div>
 ...
 {imagesPreviews.length < 5 && (
 <label className="aspect-square rounded-xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 hover:text-primary hover:border-primary transition-all cursor-pointer bg-white/20">
 ...
 <div>
 <h4 className="text-sm font-bold text-slate-800">Availability</h4>
 ...
 {/* Footer Actions */}
 <div className="px-8 py-6 bg-slate-50 border-t border-slate-100 flex justify-end items-center gap-6">
 <button
 ...
 className="flex-1 px-6 py-3 bg-slate-100 hover:bg-slate-200 text-slate-800 text-sm font-bold rounded-xl transition-all"
 >
 Create Another
 </button>
 <button
