...
const UpdateClassroom = () => {
 ...
 <h2 className="text-2xl font-semibold text-slate-800">Update Classroom {formData.roomCode}</h2>
 </div>
 </header>
 ...
 <span className="mx-2 text-slate-300">/</span>
 <span className="text-slate-900 font-semibold">Update Classroom {formData.roomCode}</span>
 </nav>
 ...
 <h3 className="text-xl font-bold text-slate-800">Room Details</h3>
