...
const NotificationPage = () => {
  ...
  const approvalCount = notifications.filter(n => 
    n.type === 'BOOKING' && n.title.toLowerCase().includes('approval')
  ).length;
  ...
  const getFilteredByTime = () => {
    ...
    if (activeTimeFilter === 'older') return [...grouped.lastWeek, ...grouped.older];
              ...
              <div className="mb-6">
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <span className={`text-xs px-2 py-0.5 rounded-full ${showUnreadOnly ? 'bg-white text-blue-600' : 'bg-gray-200 text-gray-700'}`}>
                        {unreadCount}
                      </span>
                    )}
                  </button>
                  ...
                  >
                    ...
                    {approvalCount > 0 && (
                      <span className={`text-xs px-2 py-0.5 rounded-full ${activeType === 'BOOKING' && !showUnreadOnly ? 'bg-white text-blue-600' : 'bg-gray-200 text-gray-700'}`}>
                        {approvalCount}
                      </span>
                    )}
                  </button>
