...
const ClassroomDetails = () => {
 ...
 <a onClick={() => navigate('/search-classrooms')} className="text-sm font-medium text-slate-600 hover:text-primary transition-colors cursor-pointer">Classrooms</a>
 <a onClick={() => navigate('/my-bookings')} className="text-sm font-medium text-slate-600 hover:text-primary transition-colors cursor-pointer">My Bookings</a>
 </nav>
 </div>
 ...
 className="size-9 rounded-full bg-slate-200 overflow-hidden border-2 border-primary hover:border-blue-600 transition-colors cursor-pointer"
 >
 ...
 <li key={eq._id || index} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
 <div className="flex items-center gap-4">
 ...
 <label className="block">
 <span className="text-sm font-bold text-slate-700">Booking Purpose</span>
 <select 
