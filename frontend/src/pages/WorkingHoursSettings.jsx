...
const WorkingHoursSettings = () => {
  ...
  const hasChanges = () => {
    return workingHours.start !== originalHours.start || 
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Define the operational hours for university facilities and classroom access. 
          These hours will restrict when bookings can be made.
        </p>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-800">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-700">
              ...
              <li>Bookings outside these hours will be automatically blocked</li>
