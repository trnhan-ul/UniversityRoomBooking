...
const SearchClassrooms = () => {
 ...
 <h2 className="text-xl font-bold leading-tight tracking-[-0.015em] text-[#000000]">UniBooking SaaS</h2>
 </div>
 ...
 <div className="flex w-full flex-1 items-stretch rounded-lg bg-slate-100 border-none">
 <div className="text-slate-500 flex items-center justify-center pl-4">
 <span className="material-symbols-outlined text-xl">search</span>
 </div>
 <input 
 className="form-input flex w-full min-w-0 flex-1 border-none bg-transparent focus:outline-0 focus:ring-0 text-sm font-normal placeholder:text-slate-500 px-4 pl-2" 
 ...
 className="w-full px-4 py-2 text-left text-sm hover:bg-slate-100 flex items-center gap-3 transition-colors"
 >
 ...
 {/* Headline Section */}
 <div className="mb-8">
 <h1 className="text-black tracking-tight text-4xl font-bold leading-tight pb-2">Classrooms</h1>
 <p className="text-slate-500">Discover and book rooms across campus in real-time.</p>
 </div>
 ...
 {/* Capacity Slider */}
 <div className="space-y-4">
 <p className="text-sm font-bold text-slate-700 uppercase tracking-wider">Capacity Range</p>
 ...
 <div className="space-y-4">
 <p className="text-sm font-bold text-slate-700 uppercase tracking-wider">Equipment</p>
 ...
 <div key={room._id} className="group bg-white border border-slate-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
 <div 
 ...
 <button className="flex-1 bg-slate-100 text-slate-500 font-bold py-2.5 rounded-lg cursor-not-allowed">Full until 2PM</button>
 ...
 <div className="flex gap-2">
 <button className="px-4 py-2 border border-slate-200 rounded-lg text-sm font-bold hover:bg-slate-100 transition-colors disabled:opacity-50" disabled>
 Previous
 </button>
