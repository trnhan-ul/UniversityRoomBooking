        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Edit Profile & Settings</h1>
                </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex items-center space-x-6 mb-8 pb-8 border-b">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center space-x-3 mt-2">
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getRoleBadgeColor(profile.role)}`}>
                            ...
                            <form onSubmit={handleProfileSubmit}>
                                <div className="mb-8">
                                    ...
                                    <p className="text-sm text-gray-600 mb-6">Update your basic profile information and preferences.</p>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-1">Primary email is managed by your institution</p>
                                        </div>
