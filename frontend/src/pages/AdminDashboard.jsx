...
const AdminDashboard = () => {
  ...
  const [topRooms] = useState([
    { id: 1, name: 'Main Auditorium A', capacity: 500, utilization: 94, status: 'High' },
    { id: 2, name: 'Bio Lab 3', capacity: 45, utilization: 88, status: 'High' },
    { id: 3, name: 'Tech Seminar Room', capacity: 120, utilization: 82, status: 'Med' }
  ]);
  ...
  const navigationItems = [
    ...
    { label: 'User Management', icon: 'group', active: false, action: () => navigate('/user-management') },
    { label: 'Room Inventory', icon: 'meeting_room', active: false, action: null },
        ...
        <div className="p-6 flex flex-col gap-8 h-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h1 className="text-slate-900 dark:text-white text-base font-bold leading-tight">UniBooking SaaS</h1>
              <p className="text-slate-500 dark:text-slate-400 text-xs font-normal">Super Admin Console</p>
            </div>
          </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-background-light dark:bg-background-dark">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden md:block">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">{currentUser?.full_name || currentUser?.email || 'Admin'}</p>
        ...
        <div className="p-8 space-y-8 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-green-600 text-xs font-bold bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded-full">{analytics.usersTrend}</span>
              </div>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Total Users</p>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{analytics.totalUsers.toLocaleString()}</h3>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-green-600 text-xs font-bold bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded-full">{analytics.bookingsTrend}</span>
              </div>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Monthly Bookings</p>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{analytics.monthlyBookings.toLocaleString()}</h3>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-red-600 text-xs font-bold bg-red-50 dark:bg-red-900/30 px-2 py-1 rounded-full">{analytics.utilizationTrend}</span>
              </div>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Resource Utilization</p>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{analytics.utilization}</h3>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{analytics.uptime}</h3>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-base font-bold text-slate-900 dark:text-white">Booking Volume Trends</h4>
                <div className="flex gap-2">
                  <button className="px-3 py-1 text-xs font-semibold bg-slate-100 dark:bg-slate-700 rounded hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">Daily</button>
                  <button className="px-3 py-1 text-xs font-semibold bg-primary text-white rounded shadow-md hover:bg-blue-700 transition-colors">Monthly</button>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
              <h4 className="text-base font-bold text-slate-900 dark:text-white mb-6">User Role Distribution</h4>
                  ...
                  {userRoleData.map((data, idx) => (
                    <div key={idx} className="flex items-center justify-between text-sm">
                      <div className="flex items-center gap-2">
                        <span className={`w-3 h-3 rounded-full ${data.color}`}></span>
                        <span className="text-slate-600 dark:text-slate-400">{data.role}</span>
                      </div>
                      <span className="font-bold text-slate-900 dark:text-white">{data.percentage}%</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 pb-8">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-base font-bold text-slate-900 dark:text-white">Recent System Activity</h4>
                <a href="#" className="text-sm text-primary font-medium hover:underline">View All</a>
              </div>
              <div className="space-y-4">
                {recentActivity.map((activity) => (
                  <div key={activity.id} className="flex gap-4">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${getActivityIcon(activity.type)}`}>
                      <span className="material-symbols-outlined">{activity.icon}</span>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-slate-900 dark:text-white">{activity.title}</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">{activity.description}</p>
                      <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 uppercase">{activity.time}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-base font-bold text-slate-900 dark:text-white">Top 5 High-Utilization Rooms</h4>
                <span className="material-symbols-outlined text-slate-400 cursor-pointer hover:text-slate-600 dark:hover:text-slate-300">more_horiz</span>
              </div>
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-slate-700">
                      ...
                      <th className="pb-3 text-xs font-bold text-slate-400 uppercase tracking-wider">Capacity</th>
                      <th className="pb-3 text-xs font-bold text-slate-400 uppercase tracking-wider">Utilization</th>
                      <th className="pb-3 text-xs font-bold text-slate-400 uppercase tracking-wider">Status</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                    {topRooms.map((room) => (
                      <tr key={room.id} className="text-sm hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                        <td className="py-4 font-semibold text-slate-900 dark:text-white">{room.name}</td>
                        <td className="py-4 text-slate-500 dark:text-slate-400">{room.capacity}</td>
                        <td className="py-4">
                        ...
                        <td className="py-4">
                          <span className={`px-2 py-1 ${getStatusBadgeColor(room.status)} text-[10px] font-bold rounded uppercase tracking-wide`}>
                            {room.status}
                          </span>
                        </td>
                      </tr>
